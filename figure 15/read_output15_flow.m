%% Input Output Post Processing for Re 300
...
for kz_idx = kz_idx_list
    ...
    for i = [i_fixed]
        ...
        hillp_tick_function;
        daspect([1 1 1]);
        exportgraphics(fU1, sprintf('U_response_Re%d_c%02d_kz%g.png', Re, i, kz), ...
        ...
        %         hillp_tick_function;
        %         daspect([1 1 1]);
        %         exportgraphics(fV1, sprintf('V_response_Re%d_c%02d_kz%g.png', Re, i, kz), ...
        %             'Resolution', 600, 'BackgroundColor', 'white');
        %         close(fV1);
