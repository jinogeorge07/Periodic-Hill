...
title("response mode U 48x60 (reference)")
saveas(gcf, fullfile(outdir,'U_48x60_ref.png'));
hold on

figure(2)
pcolor(U_60to48x60)
shading interp; colorbar
title("response mode U 60x72 interpolated to 48x60")
saveas(gcf, fullfile(outdir,'U_60to48x60.png'));
hold on

figure(3)
pcolor(U_80to48x60)
shading interp; colorbar
title("response mode U 80x96 interpolated to 48x60")
saveas(gcf, fullfile(outdir,'U_80to48x60.png'));
hold on

figure(4)
pcolor(U_96to48x60)
shading interp; colorbar
title("response mode U 96x120 interpolated to 48x60")
saveas(gcf, fullfile(outdir,'U_96to48x60.png'));
hold on

figure(5)
pcolor(U_108to48x60)
shading interp; colorbar
title("response mode U 108x132 interpolated to 48x60")
saveas(gcf, fullfile(outdir,'U_108to48x60.png'));
hold on
...
pcolor(V_48x60)
shading interp; colorbar
title("response mode V 48x60 (reference)")
saveas(gcf, fullfile(outdir,'V_48x60_ref.png'));
hold on

figure(10)
pcolor(V_60to48x60)
shading interp; colorbar
title("response mode V 60x72 interpolated to 48x60")
saveas(gcf, fullfile(outdir,'V_60to48x60.png'));
hold on

figure(11)
pcolor(V_80to48x60)
shading interp; colorbar
title("response mode V 80x96 interpolated to 48x60")
saveas(gcf, fullfile(outdir,'V_80to48x60.png'));
hold on

figure(12)
pcolor(V_96to48x60)
shading interp; colorbar
title("response mode V 96x120 interpolated to 48x60")
saveas(gcf, fullfile(outdir,'V_96to48x60.png'));
hold on

figure(13)
pcolor(V_108to48x60)
shading interp; colorbar
title("response mode V 108x132 interpolated to 48x60")
saveas(gcf, fullfile(outdir,'V_108to48x60.png'));
hold on

figure(17)
pcolor(W_48x60)
shading interp; colorbar
title("response mode W 48x60 (reference)")
saveas(gcf, fullfile(outdir,'W_48x60_ref.png'));
hold on

figure(18)
pcolor(W_60to48x60)
shading interp; colorbar
title("response mode W 60x72 interpolated to 48x60")
saveas(gcf, fullfile(outdir,'W_60to48x60.png'));
hold on

figure(19)
pcolor(W_80to48x60)
shading interp; colorbar
title("response mode W 80x96 interpolated to 48x60")
saveas(gcf, fullfile(outdir,'W_80to48x60.png'));
hold on

figure(20)
pcolor(W_96to48x60)
shading interp; colorbar
title("response mode W 96x120 interpolated to 48x60")
saveas(gcf, fullfile(outdir,'W_96to48x60.png'));
hold on

figure(21)
pcolor(W_108to48x60)
shading interp; colorbar
title("response mode W 108x132 interpolated to 48x60")
saveas(gcf, fullfile(outdir,'W_108to48x60.png'));
hold on
