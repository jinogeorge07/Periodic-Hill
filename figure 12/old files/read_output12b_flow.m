...
%% Extract Re from folder name
tokens = regexp(folderpath, 'Re(\d+\.?\d*)', 'tokens');

if ~isempty(tokens)
    Re = str2double(tokens{1}{1});
else
    error('Could not find Re in folderpath.');
end
...
%load('stability_results_Re100_120x96_kz10.mat');   % expects x,y,U_hat,V_hat,W_hat,kz_list,c_list,omega
% load('stability_results_Re500_168x120_kz20_c1.mat');
% load('stability_results_Re500_168x120_kz20_c4.mat');
% load('stability_results_Re500_168x120_kz20_c6.mat');
